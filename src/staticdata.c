...
{
    void** (*jl_RTLD_DEFAULT_handle_pointer)(void) = NULL;
    int symbol_found = jl_dlsym(handle, "get_jl_RTLD_DEFAULT_handle_pointer", (void **)&jl_RTLD_DEFAULT_handle_pointer, 0);
